...
namespace ServiceHost
{
    public class EmailProcessor
    {
        ...
        public static bool SendEmailNotification(string to, string subject, string body)
        {
            ...
            smtp.Credentials = new NetworkCredential("builtsteadysoftware@gmail.com", "zrc022..");
        ...
        {
            // TODO: figure out HTML issue
            //return false;
            // read the welcome email body
            string body = null;
            using (var stream = File.Open(HttpContext.Current.Server.MapPath("~/Content/WelcomeEmail.html"), FileMode.Open))
